  ...
  <div class="input">
    ...
    <group>
      ...
      <selector
        ...
        v-model="inputFrom.single_gas_type"
        title="流体名称"
        name="name"
        :options="namelist"
        direction="rtl"
    ...
    <group>
      <x-input
        v-if="inputFrom.single_gas_type!='10'"
      ...
      <x-input
        v-if="inputFrom.single_gas_type!='11'"
      ...
      this.typelist.map(item => {
        if (item.key === val) {
          if (item.child) {
            ...
            this.namelist = [];
            this.inputFrom.single_gas_type = "";
          }
